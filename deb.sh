...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "http://seller.serverid.ooo/premscript-master/screenfetch"
...
wget -O /home/vps/public_html/index.html "http://seller.serverid.ooo/"
...
wget http://seller.serverid.ooo/premscript-master/vnstat_php_frontend-1.5.1.tar.gz
...
wget -O /etc/stunnel/stunnel.pem "https://raw.githubusercontent.com/Joss2416/premscript/master/updates/stunnel.pem"
wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/Joss2416/premscript/master/req/stunnel.conf"
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "http://seller.serverid.ooo/premscript-master/snmpd.conf"
wget -O /root/mrtg-mem.sh "http://seller.serverid.ooo/premscript-master/mrtg-mem.sh"
...
curl "http://seller.serverid.ooo/premscript-master/mrtg.conf" >> /etc/mrtg.cfg
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "http://seller.serverid.ooo/premscript-master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "http://seller.serverid.ooo/premscript-master/badvpn-udpgw64"
fi
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "http://seller.serverid.ooo/premscript-master/issue.net"
...
# download script
cd
wget http://seller.serverid.ooo/premscript-master/updates/install-premiumscript.sh -O - -o /dev/null|sh
